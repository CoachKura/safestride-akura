...
├── config.js                   # Configuration (includes Strava assets)
└── test-autofill.html         # Testing suite
```
...
```javascript
// URL Structure
https://www.akura.in/public/strava-dashboard.html
...
```javascript
// config.js now includes real Strava assets
strava: {
    clientId: '162971',
...
- **Supabase**:
  - `athletes` table with columns: uid, name, email, coach_id
