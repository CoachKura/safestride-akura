# Create Structural State Workout Templates
import sys
sys.path.insert(0, '.')
...
# Write to new file
with open('workout_templates.py', 'w', encoding='utf-8') as f:
    f.write(template_code)

print('✅ Created workout_templates.py with RED/YELLOW/GREEN templates')
print('   - RED: mobility, easy (zones 1-2)')
print('   - YELLOW: easy, tempo (zones 2-3)')
print('   - GREEN: threshold, interval, race (zones 2-5)')
