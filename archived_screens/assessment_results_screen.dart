...
import 'pace_progression_screen.dart';
...
class _AssessmentResultsScreenState extends State<AssessmentResultsScreen>
  ...
  Future<void> _generateTrainingProtocol() async {
    ...
    try {
      ...
      final evaluationData = {
        ...
        'assessment_date': widget.assessmentData['created_at'] ??
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Next: See your personalized journey to 3:30/km at Zone TH/P',
                        style: TextStyle(
  ...
  void _navigateToPaceProgression() async {
    try {
      ...
      // Get Strava data for current pace and mileage
      final profile = await Supabase.instance.client
          .from('profiles')
          .select('strava_average_pace, weekly_mileage')
          .eq('id', userId)
          .maybeSingle();
      ...
      if (profile != null) {
        // Convert Strava pace to min/km (Strava stores as seconds/km)
      ...
      // Determine experience level based on AISRI and mileage
      ExperienceLevel experienceLevel;
      if (widget.aistriScore >= 75 && currentMileage >= 60) {
        experienceLevel = ExperienceLevel.advanced;
      } else if (widget.aistriScore >= 60 || currentMileage >= 40) {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => PaceProgressionScreen(
            ...
            aisriScore: widget.aistriScore,
            experienceLevel: experienceLevel,
          ),
        ),
      );
    } catch (e) {
      // If error, fall back to athlete goals screen
      print('Error navigating to pace progression: $e');
