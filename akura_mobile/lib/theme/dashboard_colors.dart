...
class DashboardColors {
  ...
  static const stepsGradient = [Color(0xFF667EEA), Color(0xFF764BA2)]; // Blue-Purple
  static const distanceGradient = [Color(0xFFF79D00), Color(0xFF64F38C)]; // Orange-Green
  static const caloriesGradient = [Color(0xFFFF6B6B), Color(0xFFFFD93D)]; // Red-Yellow
  static const sleepGradient = [Color(0xFFF79D00), Color(0xFF667EEA)]; // Orange-Blue
  static const heartRateGradient = [Color(0xFFFF6B9D), Color(0xFFC837AB)]; // Pink-Purple
