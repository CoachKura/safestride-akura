...
class WorkoutCalendarEntry {
  ...
  factory WorkoutCalendarEntry.fromGpsActivity(Map<String, dynamic> json) {
    ...
    final distanceKm = ((json['distance_meters'] as num) / 1000).toStringAsFixed(2);
    ...
    if (json['avg_pace'] != null) {
      details.add('Pace: ${(json['avg_pace'] as num).toStringAsFixed(2)} min/km');
    }
...
class Workout {
  ...
  factory Workout.fromJson(Map<String, dynamic> json) {
    return Workout(
      ...
      equipmentNeeded: (json['equipment_needed'] as List)
          .map((e) => e as String)
          .toList(),
    );
  }
