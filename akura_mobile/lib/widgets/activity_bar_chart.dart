          ...
          child: Row(
            ...
            children: List.generate(data.length, (index) {
              final barHeight = maxValue > 0
                  ? (data[index] / maxValue * height).clamp(minBarHeight, height)
                  : minBarHeight;
          ...
          SizedBox(
            ...
            child: Row(
              ...
              children: List.generate(widget.data.length, (index) {
                ...
                final barHeight = maxValue > 0
                    ? (item.value / maxValue * widget.height).clamp(minBarHeight, widget.height)
                    : minBarHeight;
        ...
        SizedBox(
          ...
          child: Row(
            ...
            children: List.generate(7, (index) {
              final barHeight = maxValue > 0
                  ? (paddedData[index] / maxValue * height).clamp(minBarHeight, height)
                  : minBarHeight;
