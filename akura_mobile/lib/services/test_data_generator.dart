...
class TestDataGenerator {
  ...
  static Map<String, dynamic> generateSevereAssessment() {
    return {
      ...
      'previous_injuries': 'IT band syndrome (2024), Runner\'s knee (2023), Shin splints (2022)',
  ...
  static Map<String, int> calculateMockPillarScores(Map<String, dynamic> assessment) {
    // This is a simplified version - the real calculator uses the full AISRI algorithm
    int ankleDorsi = assessment['ankle_dorsiflexion_cm'] as double > 10 ? 80 : 50;
    int hipStrength = assessment['hip_abduction_reps'] as int > 20 ? 85 : 55;
    int balance = assessment['balance_test_seconds'] as int > 15 ? 80 : 55;
  ...
  static AssessmentReport generateTestReport({
    ...
    final gaitPathologies = GaitPathologyAnalyzer.analyzeGaitPatterns(assessmentData);
