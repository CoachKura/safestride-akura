...
class StravaAnalyzer {
  ...
  static StravaAnalysis analyzeActivities(List<Map<String, dynamic>> activities, Map<String, dynamic>? aisriData) {
    ...
    for (var activity in activities) {
      ...
      if (activity['average_cadence'] != null) {
        totalCadence += (activity['average_cadence'] as num).toDouble() * 2; // Strava reports half cadence
        cadenceCount++;
      }
    ...
    final avgPace = totalTime > 0 ? (totalTime / 60) / (totalDistance / 1000) : 0.0; // min/km
