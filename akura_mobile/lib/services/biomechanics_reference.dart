...
class ROMStandards {
  ...
  static const int ankleGreaterThan12cmReduction = -20; // -20% lower leg injuries
  static const int anklePerCmPowerLoss = 10; // Each 1cm deficit = ~10% power loss
  static const int anklePerCmStrideLengthGain = 5; // Each 1cm = ~5% stride length
...
class GaitCyclePhases {
  ...
  static const int achillesTendonEnergyStorage = 35; // Joules during late midstance
}
...
class InjuryRiskData {
  ...
  static const int knockKneesACLInjury = 300; // +300% risk (Hewett et al., 2005)
  
  // Overpronation injury risks
  static const int overpronationPlantarFasciitis = 60; // +60% risk
  static const int overpronationPTT = 55; // +55% risk (posterior tibial tendinopathy)
  ...
  static const int underpronationStressFractures = 60; // +60% risk (MT 4-5, fibula)
...
class ClinicalDecisionRules {
  ...
  static bool requiresImmediateReferral(Map<String, dynamic> assessment) {
    ...
    // Critical thresholds
    if (ankleDorsi < 6.0 && currentPain.toLowerCase().contains('pain')) return true;
...
class ResearchCitations {
  static const ankleDorsiflexion = 'Howe et al. (2011) - Weight-bearing lunge test validity';
  static const hipAbduction = 'Fredericson et al. (2000) - Hip abductor mechanics in IT band syndrome';
  static const kneeValgus = 'Hewett et al. (2005) - Dynamic knee valgus and ACL injury mechanisms';
  static const pronationVelocity = 'Hamill et al. (1992) - Foot kinematics during running';
  static const overpronationMechanics = 'Cornwall & McPoil (1999) - Foot mechanics and pronation';
  static const gluteStrengthening = 'Selkowitz et al. (2013) - Glute medius activation exercises';
  static const ankleMobility = 'Hoch & McKeon (2011) - Dorsiflexion improvements post-intervention';
  static const copenhagenPlank = 'Thorborg et al. (2016) - Hip adduction strength protocols';
}
