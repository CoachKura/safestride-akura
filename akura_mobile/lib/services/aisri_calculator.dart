...
class AISRICalculator {
  ...
  static Map<String, dynamic> calculateScore(Map<String, dynamic> assessment) {
    ...
    int totalScore = ((adaptability + injuryRisk + fatigue + recovery + intensity + consistency) / 6).round();
  ...
  static int _calculateAdaptability(Map<String, dynamic> a) {
    ...
    if (shoulderRotation == 'Upper back' || shoulderRotation == 'Between shoulder blades') {
