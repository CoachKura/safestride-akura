...
class _WorkoutBuilderScreenState extends State<WorkoutBuilderScreen> {
  ...
  List<StrengthExercise> _strengthExercises = [];
          ...
          children: [
            ...
            Row(
              children: [
                ...
                DropdownButton<WorkoutUnit>(
                  value: _warmupUnit,
                  items: [WorkoutUnit.kilometers, WorkoutUnit.miles, WorkoutUnit.minutes]
                      .map((unit) => DropdownMenuItem(
                            value: unit,
                            child: Text(unit.shortName),
                          ))
    ...
    switch (_selectedType) {
      ...
      case WorkoutType.restDay:
        details = RestDayWorkout(
          reason: _restReasonController.text.isEmpty ? null : _restReasonController.text,
        ).toJson();
        break;
...
class _AddStrengthExerciseDialog extends StatefulWidget {
  ...
  @override
  State<_AddStrengthExerciseDialog> createState() => _AddStrengthExerciseDialogState();
}
