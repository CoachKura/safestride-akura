    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _buildStatItem('Weekly Distance', '${profile.weeklyDistance.toStringAsFixed(1)} km'),
              _buildStatItem('Avg Pace', '${profile.avgPace.toStringAsFixed(1)} min/km'),
              _buildStatItem('Runs/Week', profile.weeklyRuns.toStringAsFixed(1)),
            ],
          ),
          const SizedBox(height: 12),
          Row(
            children: [
              _buildStatItem('Longest Run', '${profile.longestRun.toStringAsFixed(1)} km'),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildFeatureRow(Icons.calendar_month, '4 weeks of structured training'),
