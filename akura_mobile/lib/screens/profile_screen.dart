  ...
  Future<void> _loadProfile() async {
    try {
      ...
      setState(() {
        ...
        weeklyGoal = (profileResponse?['weekly_goal_distance'] ?? 50.0).toDouble();
        isLoading = false;
      });
    } catch (e) {
  ...
  Future<void> _disconnectStrava() async {
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Your synced workouts will remain, but we will stop syncing new activities.'),
        actions: [
          TextButton(
            ...
            child: Column(
              children: [
                ...
                _MenuItem(
                  ...
                  onTap: isStravaConnected ? _disconnectStrava : _connectStrava,
                ),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: _isAnalyzing ? null : _analyzeWorkoutData,
                      icon: _isAnalyzing
                          ? const SizedBox(
                              width: 20,
                              height: 20,
                      ...
                      label: Text(_isAnalyzing ? 'Analyzing...' : 'Analyze My Data'),
                      style: ElevatedButton.styleFrom(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: Text(_isGenerating ? 'Generating...' : 'Generate Protocol'),
                      style: ElevatedButton.styleFrom(
