...
class _EvaluationFormScreenState extends State<EvaluationFormScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      final scoreData = AISRICalculator.calculateScore({
        ...
        'ankle_dorsiflexion_cm': double.parse(_ankleDorsiflexionController.text),
        ...
        'shoulder_abduction_angle': int.parse(_shoulderAbductionController.text),
      ...
      await Supabase.instance.client
        ...
        'recent_10k_time': _recent10kController.text.isNotEmpty ? _recent10kController.text : null,
        'recent_half_time': _recentHalfController.text.isNotEmpty ? _recentHalfController.text : null,
        'fitness_level': _selectedFitnessLevel,
      ...
      await Supabase.instance.client
          .from('profiles')
          .update({'current_aifri_score': scoreData['aifri_score']})
          .eq('id', userId);
          ...
          MaterialPageRoute(
            builder: (context) => AssessmentResultsScreen(
              assessmentData: {
                ...
                'ankle_dorsiflexion_cm': double.tryParse(_ankleDorsiflexionController.text),
                'knee_flexion_gap_cm': double.tryParse(_kneeFlexionController.text),
                'knee_extension_strength': _selectedKneeStrength,
                'hip_flexion_angle': int.tryParse(_hipFlexionController.text),
                'hip_abduction_reps': int.tryParse(_hipAbductionController.text),
                'hamstring_flexibility_cm': double.tryParse(_hamstringFlexController.text),
                'balance_test_seconds': int.tryParse(_balanceTestController.text),
                'plank_hold_seconds': int.tryParse(_plankHoldController.text),
                'shoulder_flexion_angle': int.tryParse(_shoulderFlexionController.text),
                'shoulder_abduction_angle': int.tryParse(_shoulderAbductionController.text),
                'shoulder_internal_rotation': _selectedShoulderRotation,
                'neck_rotation_angle': int.tryParse(_neckRotationController.text),
                'neck_flexion_status': _selectedNeckFlexion,
                'resting_heart_rate': int.tryParse(_restingHRController.text),
                'perceived_fatigue': _perceivedFatigue.toInt(),
                'previous_injuries': _injuryHistoryController.text,
                'current_pain': _currentPain.toInt(),
                'weekly_mileage': double.tryParse(_weeklyMileageController.text),
  ...
  int _getTrainingFrequencyDays(String frequency) {
    switch (frequency) {
      case '1-2 days/week':
        return 2;
      case '3-4 days/week':
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            items: ['1-2 days/week', '3-4 days/week', '5-6 days/week', '7+ days/week']
                .map((freq) => DropdownMenuItem(value: freq, child: Text(freq)))
                .toList(),
            onChanged: (value) => setState(() => _selectedTrainingFrequency = value!),
          ),
  ...
  Widget _buildStep6PhysicalAssessments() {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Icon(Icons.accessibility_new, size: 64, color: Colors.deepPurple),
          const SizedBox(height: 16),
          const Text(
            'Physical Assessments',
            style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
          ...
          // 2. Knee Flexion ROM
          _buildTestContainer(
            imagePath: 'assets/images/assessments/Knee Flexion (Heel-to-Buttock) Test.png',
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: ['Deep squat (>90°)', 'Moderate (45-90°)', 'Cannot perform (<45°)']
                      .map((depth) => DropdownMenuItem(value: depth, child: Text(depth)))
                      .toList(),
                  onChanged: (value) => setState(() => _selectedKneeStrength = value!),
                ),
              ],
            ),
          ),
          ...
          _buildTestContainer(
            imagePath: 'assets/images/assessments/Hip Abduction Strength Test.png',
          ...
          _buildTestContainer(
            imagePath: 'assets/images/assessments/Hamstring Flexibility (Sit-and-Reach).png',
          ...
          _buildTestContainer(
            imagePath: 'assets/images/assessments/balance test instructional diagram.png',
          ...
          _buildTestContainer(
            ...
            instructions: '1. Raise arm forward and overhead\n2. Keep arm straight\n3. Estimate maximum angle',
          ...
          _buildTestContainer(
            imagePath: 'assets/images/assessments/Shoulder Abduction ROM Test.png',
            title: 'Shoulder Abduction ROM',
            instructions: '1. Raise arm sideways to overhead\n2. Keep arm straight\n3. Estimate angle',
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: ['Cannot reach', 'Lower back', 'Mid-back']
                      .map((level) => DropdownMenuItem(value: level, child: Text(level)))
                      .toList(),
                  onChanged: (value) => setState(() => _selectedShoulderRotation = value!),
                ),
              ],
            ),
          ),
          ...
          _buildTestContainer(
            ...
            instructions: '1. Turn head to look over shoulder\n2. Estimate angle\n3. Average both sides',
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: ['Within 2cm', '2-5cm gap', '>5cm gap']
                      ...
                      .toList(),
                  onChanged: (value) => setState(() => _selectedNeckFlexion = value!),
                ),
              ],
            ),
          ),
          ...
          _buildTestContainer(
            ...
            instructions: '1. Check pulse immediately after waking\n2. Count for 60 seconds\n3. Record BPM',
            ...
            child: Column(
              ...
              children: [
                ...
                Slider(
                  ...
                  onChanged: (value) => setState(() => _perceivedFatigue = value),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('1 = Energized', style: TextStyle(fontSize: 12, color: Colors.grey[600])),
                    Text('10 = Exhausted', style: TextStyle(fontSize: 12, color: Colors.grey[600])),
                  ],
                ),
              ],
            ),
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            items: ['5K', '10K', 'Half Marathon', 'Marathon', 'Ultra']
                ...
                .toList(),
            onChanged: (value) => setState(() => _selectedRaceDistance = value!),
          ),
          const SizedBox(height: 16),
          ListTile(
