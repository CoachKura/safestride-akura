...
**Database Connection:**
- **Host:** db.bdisppaxbvygsspcuymb.supabase.co
- **Port:** 5432
- **Database:** postgres
- **User:** postgres
- **Password:** Akura@2026$
...
### Via Docker (manual)
```powershell
docker run -it --rm -e PGPASSWORD="Akura@2026$" postgres:16-alpine psql -h db.bdisppaxbvygsspcuymb.supabase.co -p 5432 -U postgres -d postgres
```
